...
function hideEles(num, type){
    switch(num){
        ...
        case 6:
            setTimeout(function(){
                $('.end-1').removeClass('show');
            }, 100);
            setTimeout(function(){
                $('.end-2').removeClass('show');
            }, 150);
            break;
        default:
            break;
...
function removeMovieClass(num){
    switch(num){
        case 0:
            ...
            break;
        case 1:
            $('.p1-2, .p1-3, .p1-4').removeClass('bounceInRight bounceInLeft bounceOutLeft bounceOutRight');
            break;
        case 2:
            $('.p2-2, .p2-3, .p2-4').removeClass('bounceInRight bounceInLeft bounceOutLeft bounceOutRight');
            break;
        case 3:
            $('.p3-2').removeClass('bounceInRight bounceInLeft bounceOutLeft bounceOutRight');
            break;
        case 4:
            $('.p4-2, .p4-3').removeClass('bounceInRight bounceInLeft bounceOutLeft bounceOutRight');
            break;
        case 5:
            $('.p5-1, .p5-2').removeClass('show');
            break;
        case 6:
            $('.end-1').removeClass('show');
            $('.end-2').removeClass('show');
